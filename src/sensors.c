#include <Arduino.h>
void read_humidity_temperature(float *hu, float *tempC, float *tempF, float *temp_index){ //Readings of humidity and temperature may take up to 2s and the post data processing takes aaround 250ms (pretty slow sensor)
